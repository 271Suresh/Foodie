<?php
  ...
  //  echo $_SESSION['login_user'];
    ...
    $sql = "select * from restaurant where area = '$area'";
...
<body>
    ...
    <section class="banner-area text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6>Foodie- Order Online</h6>
                    <h1>Order your <span class="prime-color">Favorite </span>Food<br>  
                    <span class="style-change">from your <span class="prime-color">Favorite</span> Restaurant</span></h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        <h3><span class="style-change">welcome</span> <br>to Foodie</h3>
        ...
        <div class="container">
            ...
            <div class="row">
                <?php  while ($row = $result->fetch_assoc()) {
                            ...
                            $image = $row['photo'];
                            $image_src = "pics/".$image;
                     ?>
                <div class="col-md-4 col-sm-6">
                    <div class="single-food">
                        <div class="food-img">
                    <?php         echo      '<a href="menu.php?rid='.$result3.'"> '                  ?>
                            <img width="400" height="300" src="<?php echo $image_src; ?>" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5><?php echo $row['restname']; ?></h5>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-food">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">₹140.00</span>
                            </div>
                    ...
                    <div class="single-food mt-5 mt-sm-0">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">₹90.00</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-md-0">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>topu lasange</h5>
                                <span class="style-change">₹120.00</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>bean salad</h5>
                                <span class="style-change">₹80.00</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                    ...
                    <div class="single-food mt-5">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">₹110.00</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-widget single-widget1">
                            <a href="index.html"><img width="300" src="assets/images/logo/logo.png" alt=""></a>
